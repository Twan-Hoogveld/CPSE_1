...
const char godfather[]    = "Godfather:d=8,o=7,b=80:e5,a5,c6,b5,a5,c6,a5,b5,a5,f5,g5,2e5,e5,e5,a5,c6,b5,a5,c6,a5,b5,a5,e5,e5,2d5,d5,d5,f5,g#5,2b5,b5,d5,f5,g#5,2a5,a5,c5";

int main( void ){	
   

    note_printer pr;
    std::ofstream melody_file("melody.cpp", std::ofstream::trunc | std::ofstream::ate);
    melody_file << "void play( note_player & p ){\n";
   
    if( 1 ){ rtttl_play( pr, one ); }
